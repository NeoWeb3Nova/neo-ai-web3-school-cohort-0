...
- [x] 登录 WCB 学习面板，确认明日具体任务
- [x] 深度阅读 Prompt 与 Context 章节
- [x] 尝试本地 Hermes Agent 的一个简单任务（如 web_search 或 web_extract）
- [x] 整理今日学习中的一条 Handbook 问题到 handbook-feedback/

## 晚间复盘

- **完成度**: 100% — 今日所有任务均已完成
- **打卡状态**: ✅ 已在 WCB 学习面板正确打卡
- **收获**: 全面覆盖 AI 基础回顾，从 LLM 到 Prompt 再到 Context 和 Agent，为后续 Web3 Bridge 学习打下基础
