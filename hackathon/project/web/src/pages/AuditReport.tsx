...
export default function AuditReport() {
 ...
 {/* By Vendor */}
 <div className="glass-card rounded-im p-4 lg:p-5">
 <h3 className="text-sm font-semibold text-text-primary mb-4 font-display">Spending by Vendor</h3>
 <div className="h-52 lg:h-56">
 <ResponsiveContainer width="100%" height="100%">
 ...
 <h3 className="text-sm font-semibold text-text-primary font-display">Transaction Ledger</h3>
 </div>
