...
export default function AttackDemo() {
  ...
  return (
    <div className="space-y-5 animate-fade-in">
      {/* Header */}
      <div className="glass-card rounded-xl p-4 lg:p-5 border-accent-coral/20 transition-all duration-200 hover:border-accent-coral/40">
        <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-xl bg-accent-coral/10 flex items-center justify-center border border-accent-coral/20 shrink-0">
              <ShieldAlert className="w-6 h-6 text-accent-coral" strokeWidth={1.5} />
            </div>
            <div>
              <h2 className="text-base font-semibold text-text-primary tracking-tight font-display italic">
          ...
          <div className="flex items-center gap-3 self-start sm:self-auto">
            <button
              ...
              className="px-3 py-2 rounded-lg text-xs font-medium btn-ghost"
            >
              Clear
            </button>
            <button
              ...
              disabled={runningAll}
              className="flex items-center gap-2 px-4 py-2 rounded-lg text-sm btn-gold disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {runningAll ? (
        ...
        {ATTACK_SCENARIOS.map((scenario) => {
          ...
          return (
            ...
            >
              ...
              <div className="p-4 lg:p-5">
                <div className="flex items-start justify-between gap-3">
                  <div className="flex items-center gap-3 min-w-0">
                    <div className="w-10 h-10 rounded-xl bg-accent-coral/10 flex items-center justify-center border border-accent-coral/15 shrink-0">
              ...
              {/* Terminal Output */}
              {result && (
                <div className="border-t border-border-default bg-bg-primary/80 p-3 lg:p-4">
      ...
      {Object.values(results).filter((r) => r.status === 'blocked').length === 5 && (
        <div className="glass-card rounded-xl p-5 lg:p-6 border-accent-patina/30 bg-accent-patina/5 text-center animate-fade-in">
          <div className="w-12 h-12 rounded-xl bg-accent-patina/10 flex items-center justify-center mx-auto mb-3 border border-accent-patina/20">
